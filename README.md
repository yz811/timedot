...
我认为这个应用就是一个简单，美观的计时器。让人能直观的感受今天还能工作多久，已经过去了多久。同时也能简单的记录一些note，以及做一些计时工作。
这个ui的灵感来源于小红书上一些博主给iphone设计的软件。说白了我直接抄的。但他们应该除了显示点点之外没有别的功能了。
我的版本除了显示时间，主要的升级在于添加了滑动计时以及备注功能。我尽量让一切操作都变得便捷。并且减少视觉负担。（我瞎说的）
总之用用看。还有一些细节需要调整但是已经非常够用了。
# Time Dots ⏳
