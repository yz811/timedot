...
![Screenshot Placeholder](https://via.placeholder.com/800x400?text=Application+Screenshot+Here)
*(建议在此处替换为您软件的实际运行截图)*
...
* **穿透模式 (Lock Mode)**：一键锁定，窗口背景变透明并允许鼠标穿透。它像水印一样浮在桌面上，完全不干扰你的正常工作。
